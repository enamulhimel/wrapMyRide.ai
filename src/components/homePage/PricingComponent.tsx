...
const PricingComponent = () => {
  return (
    <div className=" pt-[150px] mx-auto overflow-hidden lg:px-0 px-5 ">
    <CommonWrapper>
       <HeroHeader className="text-center lg:w-[768px] mx-auto mb-20"> 
      <h2 >Simple Pricing, Powerful Value</h2>
      <p className="lg:text-lg text-base text-[#FFFFFFB2] font-normal pt-6 text-center font-secondary">Choose the plan that fits your goals, whether you're an individual or a business looking to generate leads.</p>
