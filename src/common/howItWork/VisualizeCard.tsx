...
const VisualizeCard: React.FC<VisualizeCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10   h-full text-center flex flex-col items-center  lg:w-[768px] mx-auto">
     <SectionHeader > {header}
          <p className="text-white text-lg leading-7 font-medium pt-6 font-secondary">{paragraph}</p>
     </SectionHeader>
    <VisualizeButton className="mt-8 text-center"> {buttonText} </VisualizeButton>
